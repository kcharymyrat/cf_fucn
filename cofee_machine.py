...
# cup = 1
#
# coffee_cup_num = int(input("How many cups of coffee do you need: "))
# print(f"{water * coffee_cup_num} ml of water is needed")
# print(f"{milk * coffee_cup_num} ml of milk is needed")
# print(f"{coffee * coffee_cup_num} gr of coffee is needed")
# print(f"{cup * coffee_cup_num} cup(s) needed")
...
# CUP = 1
#
# water_stock = int(input("Enter amount of water in stock: "))
# milk_stock = int(input("Enter amount of milk in stock: "))
# coffee_stock = int(input("Enter amount of coffee in stock: "))
# cup_stock = int(input("Enter amount of cups in stock: "))
#
# requested_cup_num = int(input("How many cups of coffee do you need: "))
#
# max_cups_water = water_stock // WATER
# max_cups_milk = milk_stock // MILK
# max_cups_coffee = coffee_stock // COFFEE
# max_cups_cup = cup_stock // CUP
# max_cups = min(max_cups_water, max_cups_milk, max_cups_coffee, max_cups_cup)
#
# if max_cups >= requested_cup_num:
#     print("Yes, I can prepare that amount") if max_cups == requested_cup_num else print(f"Yes, and {max_cups - requested_cup_num} more cup(s)")
# else:
#     print(f"No, I can prepare only {max_cups} cup(s)") if max_cups != 0 else print("No, I can not prepare that amount")
